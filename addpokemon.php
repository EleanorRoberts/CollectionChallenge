...
<form method="post">
    ...
    <label for="attack">Attack
        <input type="number" name="attack" required /></label>
    <label for="defense">Defense
        <input type="number" name="defense" required /></label>
    <label for="spAttack">Sp. Attack
        <input type="number" name="spAttack" required /></label>
    <label for="spDefense">Sp. Defense
        <input type="number" name="spDefense" required/></label>
    <label for="speed">Speed
        <input type="number" name="speed" required/></label>
